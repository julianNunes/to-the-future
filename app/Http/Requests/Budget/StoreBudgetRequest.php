...
class StoreBudgetRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'automaticGenerateYear' => $this->normalizeBoolean($this->automaticGenerateYear),
            'includeFixExpenses' => $this->normalizeBoolean($this->includeFixExpenses),
    ...
    public function rules(): array
    {
        return [
            ...
            'automaticGenerateYear' => ['nullable', 'boolean'],
            'includeFixExpenses' => ['nullable', 'boolean'],
