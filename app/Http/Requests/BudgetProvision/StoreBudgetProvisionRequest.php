...
class StoreBudgetProvisionRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'description' => $this->normalizeDescription($this->description),
    ...
    protected function normalizeDescription(mixed $value): mixed
    {
        if (is_array($value)) {
