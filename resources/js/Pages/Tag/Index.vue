    ...
    <v-card>
        <v-card-text>
            <v-row dense>
                ...
                <v-col md="12">
                    <v-data-table :headers="headers" :items="tags" :search="search" :loading="isLoading"
                        :loading-text="$t('default.loading-text-table')" class="elevation-3" density="compact"
                        :total-items="tags.length" :no-data-text="$t('default.no-data-text')"
                ...
                <v-form ref="form" @submit.prevent>
                    <v-row dense>
                        <v-col cols="12" sm="12" md="12">
                            <v-text-field ref="txtName" v-model="tagName" :label="$t('default.name')"
