<template>
    ...
    <v-card class="pa-4">
        <v-row dense>
            <v-col cols="12" md="3">
                <v-text-field ref="selectMonthYear" :model-value="yearMonthModel" type="month"
                    :label="$t('default.year-month')" clearable density="comfortable" @change="changeYearMonth" />
            </v-col>
            ...
            <v-col cols="3" sm="3" md="3">
                <v-text-field v-model="budgetWeek1" :label="$t('default.week-1')" density="comfortable"
                    :readonly="true" />
            </v-col>
            <v-col cols="3" sm="3" md="3">
                <v-text-field v-model="budgetWeek2" :label="$t('default.week-2')" density="comfortable"
                    :readonly="true" />
            </v-col>
            <v-col cols="3" sm="3" md="3">
                <v-text-field v-model="budgetWeek3" :label="$t('default.week-3')" density="comfortable"
                    :readonly="true" />
            </v-col>
            <v-col cols="3" sm="3" md="3">
                <v-text-field v-model="budgetWeek4" :label="$t('default.week-4')" density="comfortable"
                    :readonly="true" />
            </v-col>
        </v-row>
    </v-card>
    ...
    <div>
        <v-window v-model="tab">
            <v-window-item value="one">
                ...
                <BudgetExpenseTagOptions :budget-id="budgetId" :tags-options="budgetExpenseToTagOptions"
                ...
                <BudgetExpense :budget-id="budgetId" :year-month="yearMonthModel" :expenses="budgetExpenses"
                    :share-users="shareUsers" :installments="installments" />
                <BudgetIncome :budget-id="budgetId" :year-month="yearMonthModel" :incomes="budgetIncomes" />
                <InvoiceExpense v-for="invoice in budgetInvoices" :key="invoice.id" :invoice="invoice"
                    :share-users="shareUsers" :title-card="true" :year-month="yearMonthModel"
                    :budget-weeks="budgetWeeks" />
                <ExtractExpense v-for="extract in budgetExtracts" :key="extract.id" :extract="extract"
                    :share-users="shareUsers" :title-card="true" :year-month="yearMonthModel"
                    :budget-weeks="budgetWeeks" />
                <BudgetProvision :budget-id="budgetId" :year-month="yearMonthModel" :provisions="budgetProvisions"
                    :share-users="shareUsers" :budget-weeks="budgetWeeks" />
            </v-window-item>
            <v-window-item v-if="shareUser && budgetShareId" value="two">
                ...
                <BudgetExpenseTagOptions :tags-options="budgetShareExpenseToTagOptions"
                    :tags-options-chats="budgetShareExpenseToTagOptionCharts" :view-only="true" />
                ...
                <InvoiceExpense v-for="invoice in budgetShareInvoices" :key="invoice.id" :invoice="invoice"
                    :share-users="shareUsers" :budget-weeks="budgetShareWeeks" :title-card="true" :view-only="true" />
                <ExtractExpense v-for="extract in budgetShareExtracts" :key="extract.id" :extract="extract"
                    :share-users="shareUsers" :budget-weeks="budgetShareWeeks" :title-card="true" :view-only="true" />
                <BudgetProvision :year-month="yearMonthModel" :provisions="budgetShareProvisions"
                    :budget-weeks="budgetShareWeeks" :view-only="true" />
            </v-window-item>
        </v-window>
    </div>
